...
export default function ScanDocumentsPage() {
  ...
  // Always stop camera when page unmounts (e.g. user navigates away via drawer)
  useEffect(() => {
    return () => stopCamera();
  }, [stopCamera]);
        ...
        <div className="flex flex-col gap-4 p-4 flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-full bg-green-500 text-white px-4 py-2.5 text-sm font-medium hover:bg-green-600"
            >
